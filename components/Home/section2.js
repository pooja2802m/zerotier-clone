...
function Section2() {
  return (
    <section className="sectionContainer">
      <div className="pd-left-right-32 sectionInnerContainer">
          ...
          <div className="width-50 pd-16">
            ...
            >
              <p>
                ...
                <b>SD-WAN</b>, simplifying network management. Enjoy flexibility
                while avoiding costly hardware vendor lock-in.
              </p>
            </div>
